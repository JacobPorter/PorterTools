...
def main():
    ...
    sys.stderr.write("Removing N's from " + args[0] + "\n")
    sys.stderr.flush()
    (counter_all, counter_N) = removeN(args[0], file_type = file_type)
    later = datetime.datetime.now()
    sys.stderr.write("Total records: " + str(counter_all) + " Records with N's: " + str(counter_N) + "\n")
